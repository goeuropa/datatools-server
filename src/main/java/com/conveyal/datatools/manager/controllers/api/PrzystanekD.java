...
//TODO this itp all rozklad for 3
      ...
      przystanki[7].odjazdy1[9][8] = "O";
      przystanki[7].odjazdy1[10][53] = "O";
      przystanki[7].odjazdy1[13][5] = "O";
...
//TODO wpisac dalsze rozklady powrot
        ...
        for ( int k = 0 ; k < n ; k++ ){
          ...
          przystanki2[k].przystanki[8] = "Koninko - H&M";
          przystanki2[k].przystanki[8] = "Koninko - Koninko Węzeł";
      ...
      przystanki2[0].nazwa = "Kórnik - Bnin Osiedle";
      przystanki2[0].odjazdy1[16][00] = "O";
      przystanki2[1].nazwa = "Kórnik - Bnin Rynek";
      przystanki2[1].odjazdy1[15][57] = "O";
      przystanki2[2].nazwa = "Kórnik Bnin A. Krajowej";
      ...
      przystanki2[6].odjazdy1[15][46] = "O";
      przystanki2[7].nazwa = "Gądki - Gądki";
      przystanki2[7].odjazdy1[15][42] = "O";
      przystanki2[8].nazwa = "Gądki - Węzeł";
      przystanki2[8].odjazdy1[15][39] = "O";
      przystanki2[9].nazwa = "Koninko - H&M";
      przystanki2[9].odjazdy1[15][36] = "O";
      przystanki2[10].nazwa = "Koninko - Koninko Węzeł";
      przystanki2[10].odjazdy1[15][35] = "O";
      przystanki2[11].nazwa = "Jaryszki Składowa";
      przystanki2[11].odjazdy1[15][32] = "O";
        }
        ...
        for ( int k = 0 ; k < n ; k++ ){
          ...
          przystanki2[k].przystanki[4] = "Robakowo Węzeł";
          przystanki2[k].przystanki[5] = "Gądki PKP";
          przystanki2[k].przystanki[6] = "Borówiec Las";
          przystanki2[k].przystanki[7] = "Koninko Las";
          przystanki2[k].przystanki[8] = "Koninko Granatowa";
          przystanki2[k].przystanki[9] = "Koninko Dziennikarska";
          przystanki2[k].przystanki[10] = "Koninko Pisarska";
          przystanki2[k].przystanki[11] = "Szczytniki Pętla";
      ...
      przystanki2[0].odjazdy1[20][19] = "O";
      przystanki2[1].nazwa = "Kórnik Poprzeczna";
      przystanki2[1].odjazdy1[15][6] = "O";
      przystanki2[1].odjazdy1[16][9] = "O";
      przystanki2[1].odjazdy1[17][53] = "O";
      przystanki2[1].odjazdy1[20][18] = "O";
      przystanki2[2].nazwa = "Kórnik - Reja";
      przystanki2[2].odjazdy1[15][5] = "O";
      przystanki2[2].odjazdy1[16][8] = "O";
      przystanki2[2].odjazdy1[17][52] = "O";
      przystanki2[2].odjazdy1[20][17] = "O";
      przystanki2[3].nazwa = "Skrzynki Jeziorna";
      przystanki2[3].odjazdy1[15][2] = "O";
      przystanki2[3].odjazdy1[16][5] = "O";
      przystanki2[3].odjazdy1[17][49] = "O";
      przystanki2[3].odjazdy1[20][14] = "O";
      przystanki2[3].nazwa = "Robakowo Węzeł";
      przystanki2[3].odjazdy1[14][58] = "O";
      przystanki2[3].odjazdy1[16][1] = "O";
      przystanki2[3].odjazdy1[17][45] = "O";
      przystanki2[3].odjazdy1[20][10] = "O";
      przystanki2[4].nazwa = "Gądki PKP";
      przystanki2[4].odjazdy1[14][56] = "O";
      przystanki2[4].odjazdy1[15][59] = "O";
      przystanki2[4].odjazdy1[17][43] = "O";
      przystanki2[4].odjazdy1[20][8] = "O";
      przystanki2[5].nazwa = "Borówiec Las";
      przystanki2[5].odjazdy1[14][53] = "O";
      przystanki2[5].odjazdy1[15][56] = "O";
      przystanki2[5].odjazdy1[17][40] = "O";
      przystanki2[5].odjazdy1[20][5] = "O";
      przystanki2[6].nazwa = "Koninko Las";
      przystanki2[6].odjazdy1[14][51] = "O";
      przystanki2[6].odjazdy1[15][54] = "O";
      przystanki2[6].odjazdy1[17][38] = "O";
      przystanki2[6].odjazdy1[20][3] = "O";
      przystanki2[7].nazwa = "Koninko Granatowa";
      przystanki2[7].odjazdy1[14][49] = "O";
      przystanki2[7].odjazdy1[15][52] = "O";
      przystanki2[7].odjazdy1[17][36] = "O";
      przystanki2[7].odjazdy1[20][1] = "O";
      przystanki2[8].nazwa = "Koninko Dziennikarska";
      przystanki2[8].odjazdy1[14][48] = "O";
      przystanki2[8].odjazdy1[15][51] = "O";
      przystanki2[8].odjazdy1[17][35] = "O";
      przystanki2[8].odjazdy1[20][00] = "O";
      przystanki2[9].nazwa = "Koninko Pisarska";
      przystanki2[9].odjazdy1[14][47] = "O";
      przystanki2[9].odjazdy1[15][50] = "O";
      przystanki2[9].odjazdy1[17][34] = "O";
      przystanki2[9].odjazdy1[19][59] = "O";
      przystanki2[10].nazwa = "Szczytniki Pętla";
      przystanki2[10].odjazdy1[14][46] = "O";
      przystanki2[10].odjazdy1[15][49] = "O";
      przystanki2[10].odjazdy1[17][33] = "O";
      przystanki2[10].odjazdy1[19][58] = "O";
        }
      PrzystanekD[] p2 = this.reverse(przystanki2);
      return this.merge(przystanki,p2);
    }
